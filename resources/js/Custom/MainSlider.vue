                    ...
                    <Transition name="slide-fade">
                        ...
                        <div v-if="validator == 3"
                            ...
                            <h2 :class="nestedValidator >= 1 ? 'opacity-100 -translate-y-6' : 'opacity-0 translate-y-0'"
                                class="text-gray-600 font-light md:text-4xl lg:text-5xl  duration-300  ">Almacenamiento Inteligente
                            </h2>
                            ...
                            <h2 :class="nestedValidator >= 3 ? 'opacity-100 -translate-y-6' : 'opacity-0 translate-y-0'"
                                class="text-gray-600 font-light text-center md:text-left text-sm md:text-xl duration-300  w-10/12 md:w-full  ">Elige uno de nuestros congeladores, con tecnología avanzada y un diseño que optimiza el espacio, para mantener tus alimentos en perfectas condiciones por más tiempo.</h2>
                ...
                <div class="absolute w-full duration-500" :class="checkSlider3(2)">
                    <Transition name="slide-fade">
                          ...
                          <div v-if="validator == 2"
                            ...
                            <h2 :class="nestedValidator >= 1 ? 'opacity-100 -translate-y-6' : 'opacity-0 translate-y-0'"
                                class="text-gray-600 font-light md:text-4xl lg:text-5xl  duration-300  ">Comodidad y Diseño
                            </h2>
                            ...
                            <h2 :class="nestedValidator >= 3 ? 'opacity-100 -translate-y-6' : 'opacity-0 translate-y-0'"
                                class="text-gray-600 font-light text-center md:text-left  md:text-xl duration-300  w-2/3 md:w-full  ">Elegí entre nuestras cocinas. <br>Pensadas para ofrecerte la mejor experiencia, eficiencia y estilo que mejoran tu calidad de vida.</h2>
                ...
                <div class="absolute w-full duration-500" :class="checkSlider3(1)">
                    <Transition name="slide-fade">
                        ...
                        <div v-if="validator == 1"
                            ...
                            <h2 :class="nestedValidator >= 3 ? 'opacity-100 -translate-y-6' : 'opacity-0 translate-y-0'"
                                class="text-gray-600 font-light  text-sm md:text-xl duration-300  w-1/2 md:w-full  ">Exhibidoras refrigeradas para helados y jugos, con diseño atractivo y tecnología de enfriamiento eficiente. <br><strong>¡Mantén tus productos frescos y al alcance de todos!.</strong> </h2>
                ...
                <div class="absolute w-full  duration-500" :class="checkSlider3(0)">
                    <Transition name="slide-fade">
                        ...
                        <div v-if="validator == 0"
                            ...
                            <h2 :class="nestedValidator >= 3 ? 'opacity-100 -translate-y-6' : 'opacity-0 translate-y-0'"
                                class="text-gray-600 font-light text-center md:text-left text-xs md:text-xl duration-300  w-2/3 md:w-full">Bocinas con tecnología avanzada para una experiencia auditiva única. <br><strong>¡No te lo puedes perder!</strong></h2>

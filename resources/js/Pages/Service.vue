...
function submit() {
    ...
    if (selectedFile.value) {
        ...
        imageProblem.value = "Esta archivo es obligatorio!";
        return;
    }
    axios
        .post(`/api/servicio-tecnico/send`, formData)
        .then((d) => {
...
const fileName = computed(() => {
    ...
    return {
        text: "Carga tu factura de compra...",
...
const labelClasses = computed(() => {
    const baseClasses =
        "bg-gray-300 border-gray-300 focus:outline-none focus:ring-neutral-600 focus:border-neutral-600";
...
<template>
    <MainTemplate class="bg-gray-100">
        ...
        >
            <div
                class="flex items-center w-11/12 md:w-10/12 gap-4 bg-white p-4 rounded-3xl shadow shadow-gray-300"
            >
                <div class="w-14 h-14 hidden md:flex items-center justify-center">
                    <img
                ...
                <header class="w-11/12 space-y-2">
                    <h2 class="text-neutral-600 text-xl md:text-4xl font-bold underline text-center md:text-left">
                        Garantía de productos Newkool
                    </h2>
                    <p class="text-lg text-gray-700 text-justify md:text-left">
                        En Newkool nos comprometemos con la calidad y
                        durabilidad de nuestros productos. Todos los equipos
                        cuentan con garantía ante defectos de fabricación,
            ...
            <section
                ref="target1"
                :class="
                    target1IsVisible || isDesktop == false
            ...
            >
                <div
                    class="w-11/12 md:w-10/12 flex flex-col-reverse md:flex-row items-center gap-5 md:h-[350px]"
                >
                    <div
                    ...
                    >
                        ...
                        >
                            <h3
                                class="text-neutral-600 font-semibold text-xl md:text-3xl underline text-center md:text-left"
                            >
                                Canales de contacto
                            </h3>
                            <h4 class="w-full text-justify md:text-left     ">
                              Todo servicio técnico debe ser solicitado por el consumidor final o el distribuidor comercial, comunicándose a nuestro Call Center o escribiendo al correo electrónico.
                            </h4>
                            <div class="flex flex-col items-center w-full gap-2">
                                <a
                                    href="https://api.whatsapp.com/send?phone=584148811721&text=Hola%20NewKool,%20me%20gustaria%20saber%20mas%20sobre%20sus%20productos."
                                    class="flex items-center rounded-xl bg-newkool-red border border-newkool-red text-white px-3 py-1 duration-200 hover:bg-white hover:text-newkool-red gap-2 w-full"
                                >
                                    <font-awesome-icon
                                        :icon="['fab', 'whatsapp']"
                                    />
                                ...
                                <button
                                    @click="scrollToForm"
                                    class="flex items-center rounded-xl bg-newkool-red border border-newkool-red text-white px-3 py-1 duration-200 hover:bg-white hover:text-newkool-red gap-2 w-full cursor-pointer"
                                >
                                    <font-awesome-icon
                                        :icon="['fas', 'envelope']"
                                    />
            ...
            <div
                ref="target2"
                :class="
                    target2IsVisible || isDesktop == false
                        ? 'opacity-100 translate-x-0'
                        : 'opacity-0 translate-x-full'
                "
            ...
            >
                ...
                >
                    ...
                    <header class="w-11/12 space-y-2">
                        <h3
                            class="text-neutral-600 text-xl md:text-3xl font-semibold underline"
                        >
            ...
            <section
                ref="target3"
                :class="
                    target3IsVisible || isDesktop == false
                        ? 'opacity-100 translate-x-0'
                        : 'opacity-0 translate-x-full'
                "
                class="flex justify-center py-10 duration-700 "
            >
                <div
                    class="w-11/12 md:w-10/12 flex flex-col md:flex-row items-center gap-5 md:h-screen"
                >
                    <div class="md:w-1/2 rounded-2xl overflow-hidden py-4 border border-black h-full flex items-center justify-center">
                        <img
                    ...
                    >
                        <div class="w-10 h-10 hidden md:flex items-center justify-center">
                            <img
                        ...
                        <header
                            class="flex flex-col text-gray-700 pt-4 w-11/12 md:w-10/12 gap-4"
                        >
                            <h3
                                class="text-neutral-600 font-semibold  text-xl md:text-3xl text-center md:text-left underline"
                            >
                            ...
                            <ul class="space-y-3 text">
                                <li class="flex items-start gap-2">
                                    ...
                                    />
                                    <p class="">
                                        Instalación incorrecta, negligencia o uso inadecuado.
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    />
                                    <p class="">
                                        Daños por accidentes, variaciones de voltaje, desastres naturales o fuerza mayor.
                                    </p>
                                </li>
                                <li class="flex items-start gap-2">
                                    <img
                                    ...
                                    />
                                    <p class="">
                                        Reparaciones o modificaciones de terceros no autorizados.
                                    </p>
                                </li>
                                <li class="flex items-start gap-2">
                                    <img
                                    ...
                                    />
                                    <p class="">
                                        Desgaste normal, obstrucciones por tierra/sedimentos, o fallas por configuración inadecuada.
                                    </p>
                                </li>
                                <li class="flex items-start gap-2">
                                    <img
                                    ...
                                    />
                                    <p class="">
                                        Accesorios o Partes no cubiertos: baterías, controles remotos, piezas plásticas o cosméticas, pantallas de TV rotas, vidrio porcelano.
                                    </p>
                                </li>
                                <li class="flex items-start gap-2">
                                    <img
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    />
                                    <p class="">
                                        Costos de revisión por fallas no atribuibles al producto, ni de limpieza o mantenimiento.
                                    </p>
                                </li>
                                <li class="flex items-start gap-2">
                                    <img
                                    ...
                                    />
                                    <p class="">
                                        Daños o alteraciones en la etiqueta de garantía o número de serie.
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    />
                                    <p class="">
                                        Productos adquiridos a distribuidores no autorizados.
                                    </p>
                                </li>
                            </ul>
                        </header>
            ...
            <section
                :class="
                    target4IsVisible || isDesktop == false
                        ? 'opacity-100 translate-x-0'
                        : 'opacity-0 translate-x-full'
                "
                class="flex justify-center w-full duration-700"
            ...
            <div
                ...
                ref="target5"
                :class="
                    target5IsVisible || isDesktop == false || target4IsVisible
                        ? 'opacity-100 translate-x-0'
                        : 'opacity-0 -translate-x-full'
                "
                class="py-8  md:px-14 w-full  flex justify-center mx-auto duration-700"
            >
                <div
                    class="w-11/12 bg-white rounded-2xl shadow shadow-gray-300 p-6"
                >
                    <h2
                    ...
                    >
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-xs pl-4 font-light text-red-600">
                                {{ imageProblem }}
                            </p>
                        </div>
            ...
            >
                <div class="flex items-center justify-center w-11/12 md:w-10/12 gap-4 p-4">
                    <div class="w-14 h-14 flex items-center justify-center">
                        <img

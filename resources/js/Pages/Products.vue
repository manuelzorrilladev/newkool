...
totalPages.value = Math.ceil(
    usePage().props.products.length / countPerPage.value
);
...
function capitalize(string) {
    if (string === "automatica") {
        return "Automática";
    }
    if (string === "portatiles") {
        return "Portátiles";
    }
    ...
    <MainTemplate class="bg-gray-100">
        ...
        <section class="min-h-screen mt-10 font-main">
            <div class="flex items-center justify-center flex-col pb-8">
                ...
                <div
                    v-if="type"
                    class="text-3xl md:text-5xl font-bold text-neutral-600 capitalize"
                >
                    {{ capitalize(cleanString(type)) }}
                </div>

                <div
                    v-if="productsInPage.length > 0"
                ...
                >
                    <header
                        class="flex flex-col items-center text-newkool-red gap-6"
                    >
                        <font-awesome-icon
                        ...
                        />
                        <h2
                            class="font-bold text-2xl md:text-5xl text-center w-10/12"
                        >
                            No hay productos que encajen con tu busqueda
                        </h2>
                        <Link
                            href="/linea-blanca"
        ...
        <div
            class="overflow-hidden h-[20vw] flex items-center justify-center relative"
        >
            <img
                src="/assets/banner-images/banner-fondo-productos-desktop.png"
                alt=""
                class="hidden md:block"
            />
            <img
                src="/assets/banner-images/banner-fondo-productos-mobile.png"
                alt=""
